...
def gradient_uu(I, I_x, I_xx, I_y, I_yy, I_xy): 
    '''
    Input:
        I: the input image
...
def gradient_vv(I, I_x, I_xx, I_y, I_yy, I_xy):
    '''
    Output:
...
def gradient_vvv(I, I_x, I_xxx, I_y, I_yyy, I_xy, I_xxy, I_xyy):
    '''
    Output:
